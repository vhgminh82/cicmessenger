...
{
    /// <summary>
    /// Registers file transfer as an activity in the CICMessenger plugin system.
    ...
    {
        /// <inheritdoc />
        public virtual Guid Id => CICMessengerActivities.FileTransfer;
        ...
        /// <inheritdoc />
        public virtual Task<IDictionary<string, object>> LaunchInviteUI(ICICMessengerContext context, IChatWindow window)
        {
