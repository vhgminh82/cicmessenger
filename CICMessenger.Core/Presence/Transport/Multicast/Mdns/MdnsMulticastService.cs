...
using PresenceMessage = CICMessenger.Core.Presence.Transport.Message;

namespace CICMessenger.Core.Presence.Transport.Multicast.Mdns
{
    /// <summary>
    ...
    class MdnsMulticastService : IMulticastService, IDisposable
    {
        ...
        public void Start()
        {
            ...
            {
                // Browse for other CICMessenger peers
        ...
        void AdvertiseSelf(CICMessengerEndPoint sender)
        {
        ...
        void FireLogin(string clientId, IPEndPoint presEndPoint)
        {
            ...
            {
                Sender = new CICMessengerEndPoint(clientId, presEndPoint)
            };
        ...
        void FireLogout(DiscoveredPeer peer)
        {
            ...
            {
                Sender = new CICMessengerEndPoint(peer.ClientID, peer.PresenceEndPoint)
            };
            MessageReceived(this, new MessageReceivedEventArgs { Message = message });
        }
