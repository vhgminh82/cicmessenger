...
using CICMessenger.Core.Chat.Transport.Grpc;
...
namespace CICMessenger.Core.Chat.Transport.Host
{
    ...
    public class ChatHost: IDisposable
    {
        ...
        public void Start()
        {
            ...
            grpcApp.MapGrpcService<CICMessengerChatGrpcService>();
        ...
        /// </summary>
        public void InitiateKeyExchange(Guid sessionId, ICICMessengerEndPoint sender, ICICMessengerEndPoint recipient)
        {
        ...
        static EndPointInfo ToEndPointInfo(CICMessengerEndPoint ep)
        {
        ...
        static EndPointInfo ToEndPointInfo(ICICMessengerEndPoint ep)
        {
            return new EndPointInfo
            {
                ClientId = ep.ClientID ?? "",
        ...
        #region gRPC inbound handlers (called by CICMessengerChatGrpcService)

        internal void OnGrpcTextMessageReceived(Guid sessionId, CICMessengerEndPoint sender, TextMessagePayload payload)
        {
        ...
        internal void OnGrpcBuzzReceived(Guid sessionId, CICMessengerEndPoint sender)
        {
        ...
        internal void OnGrpcChatInviteReceived(Guid sessionId, CICMessengerEndPoint sender, ChatInvitePayload payload)
        {
            OnMessageReceived(sessionId, sender, typeof(ChatInviteMessage));
            var participants = payload.Participants.Select(p =>
                new CICMessengerEndPoint(p.ClientId, new IPEndPoint(IPAddress.Parse(p.Ip), p.Port))).ToArray();
        ...
        internal void OnGrpcUserJoined(Guid sessionId, CICMessengerEndPoint sender)
        {
        ...
        internal void OnGrpcUserLeft(Guid sessionId, CICMessengerEndPoint sender)
        {
        ...
        internal void OnGrpcUserTyping(Guid sessionId, CICMessengerEndPoint sender)
        {
        ...
        internal void OnGrpcTextMessageUpdated(Guid sessionId, CICMessengerEndPoint sender, UpdateTextPayload payload)
        {
        ...
        internal void OnGrpcActivityInvitationReceived(Guid sessionId, CICMessengerEndPoint sender, ActivityInvitePayload payload)
        {
        ...
        internal void OnGrpcActivityInvitationAccepted(Guid sessionId, CICMessengerEndPoint sender)
        {
        ...
        internal void OnGrpcActivitySessionCancelled(Guid sessionId, CICMessengerEndPoint sender)
        {
        ...
        internal void OnGrpcActivityDataReceived(Guid sessionId, CICMessengerEndPoint sender, ActivityDataPayload payload)
        {
        ...
        internal void OnGrpcSessionInfoRequested(Guid sessionId, CICMessengerEndPoint sender)
        {
        ...
        internal void OnGrpcSessionInfoReceived(Guid sessionId, CICMessengerEndPoint sender, SessionInfoPayload payload)
        {
            OnMessageReceived(sessionId, sender, typeof(SessionInfoMessage));
            var participants = payload.Participants.Select(p =>
                (ICICMessengerEndPoint)new CICMessengerEndPoint(p.ClientId, new IPEndPoint(IPAddress.Parse(p.Ip), p.Port))).ToArray();
        ...
        internal void OnGrpcKeyExchangeReceived(Guid sessionId, CICMessengerEndPoint sender, KeyExchangePayload payload)
        {
        ...
        void OnMessageReceived(Guid sessionId, ICICMessengerEndPoint sender, Type messageType)
        {
    ...
    {
        public ICICMessengerEndPoint[] Participants { get; set; } = null!;
    }
