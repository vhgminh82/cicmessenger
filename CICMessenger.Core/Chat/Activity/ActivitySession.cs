...
namespace CICMessenger.Core.Chat.Activity
{
    class ActivitySession
    {
        ...
        ICICMessengerEndPoint remoteUser;
        Guid chatSessionId;
        ...
        private ActivitySession(Guid chatSessionId, ChatHost chatHost, ICICMessengerEndPoint localUser, ICICMessengerEndPoint remoteUser, Guid Id, bool selfInitiated)
        {
        ...
        public static ActivitySession Create(Guid sessionId, ChatHost chatHost, ICICMessengerEndPoint localUser, ICICMessengerEndPoint remoteUser)
        {
            var session = new ActivitySession(sessionId, chatHost, localUser, remoteUser, Guid.NewGuid(), true);
            return session;
        }

        public static ActivitySession FromInvite(Guid sessionId, ChatHost chatHost, ICICMessengerEndPoint localUser, ICICMessengerEndPoint remoteUser, Guid activitySessionId)
        {
