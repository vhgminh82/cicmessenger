...
namespace CICMessenger.Core.Chat
{
    ...
    {
        public ICICMessengerEndPoint Sender { get; set; } = null!;
    ...
    public class SessionEventArgs : EventArgs
    {
        ...
        public SessionEventArgs(Guid sessionId, ICICMessengerEndPoint user)
        {
    ...
    public interface IChatSession
    {
        ...
        IEnumerable<ICICMessengerEndPoint> RemoteUsers { get; }
        Guid Id { get; }
        ...
        void End();
        void Invite(ICICMessengerEndPoint user);
        void UpdateUser(ICICMessengerEndPoint user);
    }
}
