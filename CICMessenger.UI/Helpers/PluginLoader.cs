...
using CICMessenger.Plugins.MessageFilter;
using CICMessenger.Plugins.MessageParser;

namespace CICMessenger.UI.Helpers;
...
public class PluginLoader
{
    ...
    public void StartExtensions(ICICMessengerContext context)
    {
